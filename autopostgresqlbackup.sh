...
DBNAMES="brimore_live brimore13_live"
...
dbdump () {
#pg_dump -p 5432 --username=$USERNAME $HOST $OPT $1 > $2
pg_dump -p 5432 --username=$USERNAME $HOST $1 > $2
return 0
}
...
#================== removing weekly backups older than 4 weeks ==============
find $BACKUPDIR/weekly/ -type f -mtime +30 -exec rm -f {} \;
#================= removing monthly backups older than 12 month ============
find $BACKUPDIR/monthly/ -type f -mtime +366 -exec ls -lah {} \;
exit 0
